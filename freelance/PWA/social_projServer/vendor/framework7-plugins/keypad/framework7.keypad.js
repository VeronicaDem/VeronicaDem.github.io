    ...
    var KeypadClassConstructor = function(Framework7Class) {
        return (function(Framework7Class) {
            ...
            Keypad.prototype.initInput = function initInput() {
                ...
                if (keypad.params.inputReadOnly) {
                    keypad.$inputEl.prop('readOnly', true);
                }
            };
            ...
            Keypad.prototype.calculator = function calculator(value) {
                    ...
                    if (value === invert) {
                        ...
                        if (value === '=') {
                            if (keypad.calcOperations[keypad.calcOperations.length - 1] === '=') {
                                if (keypad.calcOperations.length < 2) {
                                    return;
                                }
                ...
                if (value !== invert && value !== perc) {
                    keypad.calcValues.push(value);
                }
            };
            ...
            Keypad.prototype.renderButtons = function renderButtons() {
                ...
                for (var i = 0; i < keypad.params.buttons.length; i += 1) {
                    ...
                    if (button.dark) {
                        buttonClass += ' keypad-button-dark';
                    }
                    if (button.cssClass) {
                        buttonClass += " " + (button.cssClass);
                    }
            ...
            Keypad.prototype.render = function render() {
                ...
                var params = keypad.params;
                if (params.render) {
                    return params.render.call(keypad);
                }
                if (!keypad.inline) {
                    ...
                    if (modalType === 'popover') {
                        return keypad.renderPopover();
                    } else if (modalType === 'sheet') {
                        return keypad.renderSheet();
                    }
                }
            ...
            Keypad.prototype.destroy = function destroy() {
                ...
                if ($el) {
                    $el.trigger('keypad:beforedestroy', keypad);
                }
        ...
        create: function create() {
            ...
            app.keypad = {
                ...
                close: function close(el) {
                    ...
                    if (!keypad || (keypad && !keypad.opened)) {
                        return;
                    }
                    keypad.close();
                },
