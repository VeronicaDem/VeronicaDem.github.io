...
! function(e, t) {
    ...
    var Template7Context = t7ctx,
        Template7Utils = {
            ...
            parseJsVariable: function(e, n, r) {
                return e.split(/([+ \-*/^()&=|<>!%:?])/g).reduce(function(e, t) {
                    if (!t) return e;
                    if (t.indexOf(n) < 0) return e.push(t), e;
                    if (!r) return e.push(JSON.stringify("")), e;
                    var a = r;
                    return 0 <= t.indexOf(n + ".") && t.split(n + ".")[1].split(".").forEach(function(e) {
                        a = e in a ? a[e] : void 0
                    }), "string" == typeof a && (a = JSON.stringify(a)), void 0 === a && (a = "undefined"), e.push(a), e
                }, []).join("")
            },
            parseJsParents: function(e, r) {
                return e.split(/([+ \-*^()&=|<>!%:?])/g).reduce(function(e, t) {
                    if (!t) return e;
                    if (t.indexOf("../") < 0) return e.push(t), e;
                    if (!r || 0 === r.length) return e.push(JSON.stringify("")), e;
                    var a = t.split("../").length - 1,
                        n = a > r.length ? r[r.length - 1] : r[a - 1];
                    return t.replace(/..\//g, "").split(".").forEach(function(e) {
                        n = void 0 !== n[e] ? n[e] : "undefined"
                    }), !1 === n || !0 === n ? e.push(JSON.stringify(n)) : null === n || "undefined" === n ? e.push(JSON.stringify("")) : e.push(JSON.stringify(n)), e
                }, []).join("")
            },
            ...
            for (var p = s[l], c = 0; c < this.length; c += 1) {
                ...
                if (!r && d.dom7Listeners ? u = d.dom7Listeners[p] : r && d.dom7LiveListeners && (u = d.dom7LiveListeners[p]), u && u.length)
                    for (var h = u.length - 1; 0 <= h; h -= 1) {
                        var f = u[h];
                        i && f.listener === i ? (d.removeEventListener(p, f.proxyListener, o), u.splice(h, 1)) : i && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === i ? (d.removeEventListener(p, f.proxyListener, o), u.splice(h, 1)) : i || (d.removeEventListener(p, f.proxyListener, o), u.splice(h, 1))
                    }
            }
        return this
    }
    ...
    function once() {
        ...
        function l() {
            for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
            o.apply(this, e), n.off(r, i, l, s), l.dom7proxy && delete l.dom7proxy
        }
        return "function" == typeof t[1] && (r = (e = t)[0], o = e[1], s = e[2], i = void 0), l.dom7proxy = o, n.on(r, i, l, s)
    }
    ...
    Framework7Class.prototype.on = function(e, t, a) {
    ...
    }, Framework7Class.prototype.once = function(a, n, e) {
        var r = this;
        if ("function" != typeof n) return r;

        function i() {
            for (var e = [], t = arguments.length; t--;) e[t] = arguments[t];
            n.apply(r, e), r.off(a, i), i.f7proxy && delete i.f7proxy
        }
        return i.f7proxy = n, r.on(a, i, e)
        ...
        return r.eventsListeners && e.split(" ").forEach(function(a) {
            void 0 === n ? r.eventsListeners[a] = [] : r.eventsListeners[a] && r.eventsListeners[a].forEach(function(e, t) {
                (e === n || e.f7proxy && e.f7proxy === n) && r.eventsListeners[a].splice(t, 1)
            })
        }), r
    ...
    var Framework7 = function(i) {
        function o(e) {
            ...
            return Utils.extend(a, {
                ...
                passedParams: t
            }), a.root && a.root[0] && (a.root[0].f7 = a), a.useModules(), a.initData(), a.params.init && (Device.cordova && a.params.initOnDeviceReady ? $(doc).on("deviceready", function() {
                a.init()
            }) : a.init()), a
        }
        i && (o.__proto__ = i);
        ...
        return ((o.prototype = Object.create(i && i.prototype)).constructor = o).prototype.initData = function() {
            var t = this;
            t.data = {}, t.params.data && "function" == typeof t.params.data ? Utils.extend(t.data, t.params.data.bind(t)()) : t.params.data && Utils.extend(t.data, t.params.data), t.methods = {}, t.params.methods && Object.keys(t.params.methods).forEach(function(e) {
                "function" == typeof t.params.methods[e] ? t.methods[e] = t.params.methods[e].bind(t) : t.methods[e] = t.params.methods[e]
            })
        }, o.prototype.init = function() {
            var e = this;
            return e.initialized || (e.root.addClass("framework7-initializing"), e.rtl && $("html").attr("dir", "rtl"), e.root.addClass("framework7-root"), $("html").removeClass("ios md").addClass(e.theme), Utils.nextFrame(function() {
    ...
    var DeviceModule = {
        ...
        Support = (uq = !1, vq = doc.createElement("div"), "sticky -webkit-sticky -moz-sticky".split(" ").forEach(function(e) {
            uq || (vq.style.position = e, vq.style.position === e && (uq = !0))
        }), rq = uq, sq = doc.createElement("div"), {
            positionSticky: rq,
            touch: !!(0 < win.navigator.maxTouchPoints || "ontouchstart" in win || win.DocumentTouch && doc instanceof win.DocumentTouch),
            pointerEvents: !!(win.navigator.pointerEnabled || win.PointerEvent || "maxTouchPoints" in win.navigator),
            prefixedPointerEvents: !!win.navigator.msPointerEnabled,
            transition: (zq = sq.style, "transition" in zq || "webkitTransition" in zq || "MozTransition" in zq),
            transforms3d: win.Modernizr && !0 === win.Modernizr.csstransforms3d || (Bq = sq.style, "webkitPerspective" in Bq || "MozPerspective" in Bq || "OPerspective" in Bq || "MsPerspective" in Bq || "perspective" in Bq),
            flexbox: function() {
        ...
        uq, vq, Bq, zq, rq, sq, SupportModule = {
            name: "support",
            proto: {
                support: Support
            },
    ...
    function initTouch() {
        ...
        doc.addEventListener("click", function(e) {
            D("click", e)
        }, !0), Support.passiveListener ? (doc.addEventListener(o.touchEvents.start, I, U), doc.addEventListener(o.touchEvents.move, A, U), doc.addEventListener(o.touchEvents.end, B, U), doc.addEventListener(o.touchEvents.start, R, H), doc.addEventListener(o.touchEvents.move, L, H), doc.addEventListener(o.touchEvents.end, z, H)) : (doc.addEventListener(o.touchEvents.start, function(e) {
            I(e), R(e)
            ...
            if (!d) return !u && w && (Device.android && !e.cancelable || !e.cancelable || e.preventDefault()), x.activeState && M(), E && O(), !0;
            if (doc.activeElement === e.target) return x.activeState && M(), E && O(), !0;
            if (u || e.preventDefault(), i - f < x.fastClicksDelayBetweenClicks) return setTimeout(M, 0), E && O(), !0;
    ...
    function parse(e, t) {
        for (var a, n = [], r = 0, i = 0, o = "", s = t && t.delimiter || DEFAULT_DELIMITER, l = t && t.whitelist || void 0, p = !1; null !== (a = PATH_REGEXP.exec(e));) {
            var c = a[0],
                d = a[1],
                u = a.index;
            if (o += e.slice(i, u), i = u + c.length, d) o += d[1], p = !0;
                ...
                if (!p && o.length) {
                    var b = o.length - 1,
                        y = o[b];
                    (!l || -1 < l.indexOf(y)) && (h = y, o = o.slice(0, b))
                }
                o && (n.push(o), o = "", p = !1);
                var w = "+" === g || "*" === g,
                    C = "?" === g || "*" === g,
                ...
                n.push({
                    ...
                    optional: C,
                    repeat: w,
                    pattern: x ? escapeGroup(x) : "[^" + escapeString($ === s ? $ : $ + s) + "]+?"
                })
            }
        }
    ...
    function tokensToRegExp(e, t, a) {
        for (var n = (a = a || {}).strict, r = !1 !== a.start, i = !1 !== a.end, o = a.delimiter || DEFAULT_DELIMITER, s = [].concat(a.endsWith || []).map(escapeString).concat("$").join("|"), l = r ? "^" : "", p = 0; p < e.length; p++) {
            var c = e[p];
        ...
        if (i) n || (l += "(?:" + escapeString(o) + ")?"), l += "$" === s ? "$" : "(?=" + s + ")";
        else {
            var u = e[e.length - 1],
                h = "string" == typeof u ? u[u.length - 1] === o : void 0 === u;
            n || (l += "(?:" + escapeString(o) + "(?=" + s + "))?"), h || (l += "(?=" + escapeString(o) + "|" + s + ")")
        }
    ...
    function SwipeBack(e) {
            ...
            if (O) {
                ...
                if (void 0 === d && (d = !!(d || Math.abs(a - I.y) > Math.abs(t - I.x)) || t < I.x && !M.rtl || t > I.x && M.rtl), d || e.f7PreventSwipeBack || M.preventSwipeBack) O = !1;
                    ...
                    if (!D) {
                        ...
                        z && 0 === (C = A.find(".page-shadow-effect")).length && (C = $('<div class="page-shadow-effect"></div>'), A.append(C)), H && 0 === (x = B.find(".page-opacity-effect")).length && (x = $('<div class="page-opacity-effect"></div>'), B.append(x)), y && (L = w ? (R = T.find(".navbar-current:not(.stacked)"), T.find(".navbar-previous:not(.stacked)")) : (R = A.children(".navbar").children(".navbar-inner"), B.children(".navbar").children(".navbar-inner")), E = T[0].offsetWidth, f = R.children(".left, .title, .right, .subnavbar, .fading"), m = L.children(".left, .title, .right, .subnavbar, .fading"), P.iosAnimateNavbarBackIcon && (g = R.hasClass("sliding") ? (v = R.children(".left").find(".back .icon"), R.children(".left").find(".back span").eq(0)) : (v = R.children(".left.sliding").find(".back .icon"), R.children(".left.sliding").find(".back span").eq(0)), b = L.hasClass("sliding") ? L.children(".left").find(".back .icon") : L.children(".left.sliding").find(".back .icon"))), 0 < $(".sheet.modal-in").length && M.sheet && M.sheet.close($(".sheet.modal-in"))
                    }
                    ...
                    1 === Device.pixelRatio && (p = Math.round(p), c = Math.round(c)), k.swipeBackActive = !0, $([A[0], B[0]]).addClass("page-swipeback-active"), A.transform("translate3d(" + p + "px,0,0)"), z && (C[0].style.opacity = 1 - 1 * s), "md" !== M.theme && B.transform("translate3d(" + c + "px,0,0)"), H && (x[0].style.opacity = 1 - 1 * s), y && (f.each(function(e, t) {
                        var a = $(t);
                        if (a.is(".subnavbar") || (a[0].style.opacity = 1 - Math.pow(s, .33)), 0 <= a[0].className.indexOf("sliding") || R.hasClass("sliding")) {
                        ...
                        var a = $(t);
                        if (a.is(".subnavbar") || (a[0].style.opacity = Math.pow(s, 3)), 0 <= a[0].className.indexOf("sliding") || L.hasClass("sliding")) {
        ...
        function o() {
            if (M.preventSwipePanelBySwipeBack = !1, O && D) {
                ...
                i ? (k.currentRoute = B[0].f7Page.route, k.currentPage = B[0], k.pageCallback("beforeOut", A, R, "current", "next", {
                    route: A[0].f7Page.route,
                    swipeBack: !0
                }), k.pageCallback("beforeIn", B, L, "previous", "current", {
                    ...
                    $([A[0], B[0]]).removeClass("page-transitioning page-transitioning-swipeback"), y && (f.removeClass("navbar-transitioning").css({
                        ...
                        opacity: ""
                    }).transform(""), v && 0 < v.length && v.removeClass("navbar-transitioning"), b && 0 < b.length && b.removeClass("navbar-transitioning")), n = !0, k.allowPageChange = !0, i ? (1 === k.history.length && k.history.unshift(k.url), k.history.pop(), k.saveHistory(), P.pushState && History.back(), k.pageCallback("afterOut", A, R, "current", "next", {
                        route: A[0].f7Page.route,
                        swipeBack: !0
                    }), k.pageCallback("afterIn", B, L, "previous", "current", {
                        route: B[0].f7Page.route,
                        swipeBack: !0
                    }), P.stackPages && 0 <= k.initialPages.indexOf(A[0]) ? (A.addClass("stacked"), w && R.addClass("stacked")) : (k.pageCallback("beforeRemove", A, R, "next", {
                        swipeBack: !0
                    }), k.removePage(A), w && k.removeNavbar(R)), S.trigger("swipeback:afterchange", t), k.emit("swipebackAfterChange", t), k.emit("routeChanged", k.currentRoute, k.previousRoute, k), P.preloadPreviousPage && k.back(k.history[k.history.length - 2], {
                        preload: !0
    ...
    function forward(e, t) {
        ...
        if (l || "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
            ...
            var p = r.currentRoute.modal || r.currentRoute.route.modalInstance || i[a].get(),
                c = r.history[r.history.length - 2],
                d = r.findMatchingRoute(c);
            !d && c && (d = {
                url: c,
                path: c.split("?")[0],
        ...
        var u, h, f, m, v = r.dynamicNavbar,
            g = r.separateNavbar,
            b = r.$el,
            y = n,
            w = s.reloadPrevious || s.reloadCurrent || s.reloadAll;
        if (r.allowPageChange = !1, 0 === y.length) return r.allowPageChange = !0, r;
        y.length && r.removeThemeElements(y), v && (f = y.children(".navbar").children(".navbar-inner"), g && (h = r.$navbarEl, 0 < f.length && y.children(".navbar").remove(), 0 === f.length && y[0] && y[0].f7Page && (f = y[0].f7Page.$navbarEl))), s.route && s.route.route && s.route.route.keepAlive && !s.route.route.keepAliveData && (s.route.route.keepAliveData = {
            pageEl: n[0]
        });
        ...
        var E = "next";
        if (s.reloadCurrent || s.reloadAll ? E = "current" : s.reloadPrevious && (E = "previous"), y.addClass("page-" + E).removeClass("stacked").trigger("page:unstack").trigger("page:position", {
                position: E
            }), v && f.length && f.addClass("navbar-" + E).removeClass("stacked"), s.reloadCurrent) u = x.eq(x.length - 1), g && (m = $(i.navbar.getElByPage(u)));
        else if (s.reloadPrevious) u = x.eq(x.length - 2), g && (m = $(i.navbar.getElByPage(u)));
        else if (s.reloadAll) u = x.filter(function(e, t) {
            return t !== y[0]
            ...
            if (1 < x.length) {
                ...
                for (k = 0; k < x.length - 1; k += 1) {
                    ...
                    r.params.stackPages ? (x.eq(k).addClass("stacked"), x.eq(k).trigger("page:stack"), g && $(S).addClass("stacked")) : (r.pageCallback("beforeRemove", x[k], C && C[k], "previous", void 0, s), r.removePage(x[k]), g && S && r.removeNavbar(S))
                }
            }
        ...
        s.reloadPrevious || (r.currentPageEl = y[0], v && f.length ? r.currentNavbarEl = f[0] : delete r.currentNavbarEl, r.currentRoute = s.route);
        var M = s.route.url;
        s.history && (0 < (s.reloadCurrent && r.history.length) || s.replaceState ? r.history[r.history.length - (s.reloadPrevious ? 2 : 1)] = M : s.reloadPrevious ? r.history[r.history.length - 2] = M : s.reloadAll ? r.history = [M] : r.history.push(M)), r.saveHistory();
        var P = 0 < y.parents(doc).length,
            O = y[0].f7Component;
        if (s.reloadPrevious ? (O && !P ? O.$mount(function(e) {
                $(e).insertBefore(u)
            }) : y.insertBefore(u), g && f.length && (m.length ? f.insertBefore(m) : (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), h.append(f)))) : (u.next(".page")[0] !== y[0] && (O && !P ? O.$mount(function(e) {
                b.append(e)
            }) : b.append(y[0])), g && f.length && (r.$navbarEl.parents(doc).length || r.$el.prepend(r.$navbarEl), h.append(f[0]))), P ? s.route && s.route.route && s.route.route.keepAlive && !y[0].f7PageMounted && (y[0].f7PageMounted = !0, r.pageCallback("mounted", y, f, E, w ? E : "current", s, u)) : r.pageCallback("mounted", y, f, E, w ? E : "current", s, u), s.reloadCurrent && 0 < u.length ? r.params.stackPages && 0 <= r.initialPages.indexOf(u[0]) ? (u.addClass("stacked"), u.trigger("page:stack"), g && m.addClass("stacked")) : (r.pageCallback("beforeRemove", u, m, "previous", void 0, s), r.removePage(u), g && m && m.length && r.removeNavbar(m)) : s.reloadAll ? u.each(function(e, t) {
                var a = $(t),
                    n = $(i.navbar.getElByPage(a));
                r.params.stackPages && 0 <= r.initialPages.indexOf(a[0]) ? (a.addClass("stacked"), a.trigger("page:stack"), g && n.addClass("stacked")) : (r.pageCallback("beforeRemove", a, m && m.eq(e), "previous", void 0, s), r.removePage(a), g && n.length && r.removeNavbar(n))
            }) : s.reloadPrevious && (r.params.stackPages && 0 <= r.initialPages.indexOf(u[0]) ? (u.addClass("stacked"), u.trigger("page:stack"), g && m.addClass("stacked")) : (r.pageCallback("beforeRemove", u, m, "previous", void 0, s), r.removePage(u), g && m && m.length && r.removeNavbar(m))), s.route.route.tab && r.tabLoad(s.route.route.tab, Utils.extend({}, s, {
                history: !1,
                pushState: !1
            })), r.pageCallback("init", y, f, E, w ? E : "current", s, u), s.reloadCurrent || s.reloadAll) return r.allowPageChange = !0, r.pageCallback("beforeIn", y, f, E, "current", s), r.pageCallback("afterIn", y, f, E, "current", s), s.reloadCurrent && s.clearPreviousHistory && r.clearPreviousHistory(), r;
        ...
        function D() {
            ...
            y.removeClass(e).addClass("page-current").removeAttr("aria-hidden"), u.removeClass(e).addClass("page-previous").attr("aria-hidden", "true"), v && (f.removeClass(t).addClass("navbar-current").removeAttr("aria-hidden"), m.removeClass(t).addClass("navbar-previous").attr("aria-hidden", "true")), r.allowPageChange = !0, r.pageCallback("afterIn", y, f, "next", "current", s), r.pageCallback("afterOut", u, m, "current", "previous", s);
            var a = "ios" === i.theme ? r.params.preloadPreviousPage || r.params.iosSwipeBack : r.params.preloadPreviousPage;
            a || (y.hasClass("smart-select-page") || y.hasClass("photo-browser-page") || y.hasClass("autocomplete-page")) && (a = !0), a || (r.params.stackPages ? (u.addClass("stacked"), u.trigger("page:stack"), g && m.addClass("stacked")) : y.attr("data-name") && "smart-select-page" === y.attr("data-name") || (r.pageCallback("beforeRemove", u, m, "previous", void 0, s), r.removePage(u), g && m.length && r.removeNavbar(m))), s.clearPreviousHistory && r.clearPreviousHistory(), r.emit("routeChanged", r.currentRoute, r.previousRoute, r), r.params.pushState && History.clearRouterQueue()
        }

        function I() {
            var e = "page-previous page-current page-next",
                t = "navbar-previous navbar-current navbar-next";
            u.removeClass(e).addClass("page-current").removeAttr("aria-hidden"), y.removeClass(e).addClass("page-next").removeAttr("aria-hidden"), v && (m.removeClass(t).addClass("navbar-current").removeAttr("aria-hidden"), f.removeClass(t).addClass("navbar-next").removeAttr("aria-hidden"))
        }
        if (r.pageCallback("beforeIn", y, f, "next", "current", s), r.pageCallback("beforeOut", u, m, "current", "previous", s), s.animate) {
    ...
    function navigate(e, t) {
        ...
        return s.route.options ? Utils.extend(u, s.route.options, t) : Utils.extend(u, t), u.route = s, u && u.context && (s.context = u.context, u.route.context = u.context), processRouteQueue.call(l, s, l.currentRoute, function() {
    ...
    function backward(e, t) {
        var a, n, r, i, o = this,
            ...
            u = o.separateNavbar,
            h = s,
            f = o.$el.children(".page-current");
        if (h.length && o.removeThemeElements(h), d && (n = h.children(".navbar").children(".navbar-inner"), r = u ? (a = o.$navbarEl, 0 < n.length && h.children(".navbar").remove(), 0 === n.length && h[0] && h[0].f7Page && (n = h[0].f7Page.$navbarEl), a.find(".navbar-current")) : f.children(".navbar").children(".navbar-inner")), o.allowPageChange = !1, 0 === h.length || 0 === f.length) return o.allowPageChange = !0, o;
        if (o.removeThemeElements(h), c.route && c.route.route && c.route.route.keepAlive && !c.route.route.keepAliveData && (c.route.route.keepAliveData = {
                ...
                position: "previous"
            }), d && 0 < n.length && n.addClass("navbar-previous").removeClass("stacked").removeAttr("aria-hidden"), c.force && (0 < f.prev(".page-previous:not(.stacked)").length || 0 === f.prev(".page-previous").length))
            if (0 <= o.history.indexOf(c.route.url) ? (i = o.history.length - o.history.indexOf(c.route.url) - 1, o.history = o.history.slice(0, o.history.indexOf(c.route.url) + 2), p.history = o.history) : o.history[[o.history.length - 2]] ? o.history[o.history.length - 2] = c.route.url : o.history.unshift(o.url), i && o.params.stackPages) f.prevAll(".page-previous").each(function(e, t) {
                var a, n = $(t);
                u && (a = $(l.navbar.getElByPage(n))), n[0] !== h[0] && n.index() > h.index() && (0 <= o.initialPages.indexOf(n[0]) ? (n.addClass("stacked"), n.trigger("page:stack"), u && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0, c), o.removePage(n), u && 0 < a.length && o.removeNavbar(a)))
            });
            else {
                var m, v = f.prev(".page-previous:not(.stacked)");
                u && (m = $(l.navbar.getElByPage(v))), o.params.stackPages && 0 <= o.initialPages.indexOf(v[0]) ? (v.addClass("stacked"), v.trigger("page:stack"), m.addClass("stacked")) : 0 < v.length && (o.pageCallback("beforeRemove", v, m, "previous", void 0, c), o.removePage(v), u && m.length && o.removeNavbar(m))
            }
        var g, b, y = 0 < h.parents(doc).length,
            w = h[0].f7Component;

        function C() {
            0 === h.next(f).length && (!y && w ? w.$mount(function(e) {
                $(e).insertBefore(f)
            }) : h.insertBefore(f)), u && n.length && (n.insertBefore(r), 0 < r.length ? n.insertBefore(r) : (o.$navbarEl.parents(doc).length || o.$el.prepend(o.$navbarEl), a.append(n))), y ? c.route && c.route.route && c.route.route.keepAlive && !h[0].f7PageMounted && (h[0].f7PageMounted = !0, o.pageCallback("mounted", h, n, "previous", "current", c, f)) : o.pageCallback("mounted", h, n, "previous", "current", c, f)
        }
        if (c.preload) return C(), c.route.route.tab && o.tabLoad(c.route.route.tab, Utils.extend({}, c, {
            ...
            var a, n = $(t);
            u && (a = $(l.navbar.getElByPage(n))), o.params.stackPages && 0 <= o.initialPages.indexOf(t) ? (n.addClass("stacked"), n.trigger("page:stack"), u && a.addClass("stacked")) : (o.pageCallback("beforeRemove", n, a, "previous", void 0), o.removePage(n), u && a.length && o.removeNavbar(a))
        ...
        return Device.ie || Device.edge || Device.firefox && !Device.ios || o.params.pushState && c.pushState && (i ? History.go(-i) : History.back()), 1 === o.history.length && o.history.unshift(o.url), o.history.pop(), o.saveHistory(), o.currentPageEl = h[0], d && n.length ? o.currentNavbarEl = n[0] : delete o.currentNavbarEl, o.currentRoute = c.route, (Device.ie || Device.edge || Device.firefox && !Device.ios) && o.params.pushState && c.pushState && (i ? History.go(-i) : History.back()), C(), c.route.route.tab && o.tabLoad(c.route.route.tab, Utils.extend({}, c, {
            history: !1,
            pushState: !1
        })), o.pageCallback("init", h, n, "previous", "current", c, f), o.pageCallback("beforeIn", h, n, "previous", "current", c), o.pageCallback("beforeOut", f, r, "current", "next", c), c.animate ? (g = "page-previous page-current page-next", b = "navbar-previous navbar-current navbar-next", f.removeClass(g).addClass("page-current"), h.removeClass(g).addClass("page-previous").removeAttr("aria-hidden"), d && (r.removeClass(b).addClass("navbar-current"), n.removeClass(b).addClass("navbar-previous").removeAttr("aria-hidden")), o.animate(f, h, r, n, "backward", function() {
            x()
        })) : x(), o
    }
    ...
    function back() {
        ...
        var o = (n = "object" == typeof e[0] ? e[0] || {} : (a = e[0], e[1] || {})).name,
            s = n.params,
            l = n.query;
        if (o) {
            if (!(r = i.findRouteByKey("name", o))) throw new Error('Framework7: route with name "' + o + '" not found');
            if (a = i.constructRouteUrl(r, {
                    params: s,
                    query: l
                })) return i.back(a, Utils.extend({}, n, {
                name: null,
                params: null,
                query: null
            }));
            throw new Error("Framework7: can't construct URL for route with name \"" + o + '"')
        }
        var p = i.app;
        ...
        if (d || "popup popover sheet loginScreen actions customModal panel".split(" ").forEach(function(e) {
            ...
            var v = n.force && u && a;
            return u && h ? (i.params.pushState && !1 !== n.pushState && History.back(), i.currentRoute = u, i.history.pop(), i.saveHistory(), i.modalRemove(h), v && i.navigate(a, {
                reloadCurrent: !0
            })) : h && (i.modalRemove(h), a && i.navigate(a, {
                reloadCurrent: !0
            })), i
        }
        var g = i.$el.children(".page-current").prevAll(".page-previous").eq(0);
        if (!n.force && 0 < g.length) {
            if (i.params.pushState && g[0].f7Page && i.history[i.history.length - 2] !== g[0].f7Page.route.url) return i.back(i.history[i.history.length - 2], Utils.extend(n, {
                force: !0
            })), i;
            var b = g[0].f7Page.route;
            return processRouteQueue.call(i, b, i.currentRoute, function() {
                i.loadBack({
                    el: g
                }, Utils.extend(n, {
                    route: b
        ...
        if ("#" === a && (a = void 0), a && "/" !== a[0] && 0 !== a.indexOf("#") && (a = ((i.path || "/") + a).replace("//", "/")), !a && 1 < i.history.length && (a = i.history[i.history.length - 2]), (r = i.findMatchingRoute(a)) || a && (r = {
                url: a,
                path: a.split("?")[0],
        ...
        if (r.route.redirect) return redirect.call(i, "back", r, n);
        var y, w = {};
        if (r.route.options ? Utils.extend(w, r.route.options, n) : Utils.extend(w, n), w.route = r, w && w.context && (r.context = w.context, w.route.context = w.context), w.force && i.params.stackPages && (i.$el.children(".page-previous.stacked").each(function(e, t) {
                t.f7Page && t.f7Page.route && t.f7Page.route.url === r.url && (y = !0, i.loadBack({
                    el: t
                }, w))
            }), y)) return i;
        ...
        function C() {
            var a = !1;
            r.route.keepAlive && r.route.keepAliveData && (i.loadBack({
                el: r.route.keepAliveData.pageEl
            }, w), a = !0), "url content component pageName el componentUrl template templateUrl".split(" ").forEach(function(e) {
                var t;
                r.route[e] && !a && (a = !0, i.loadBack(((t = {})[e] = r.route[e], t), w))
            }), a || r.route.async && (i.allowPageChange = !1, r.route.async.call(i, r, i.currentRoute, function(e, t) {
                i.allowPageChange = !1, t && t.context && (r.context ? r.context = Utils.extend({}, r.context, t.context) : r.context = t.context, w.route.context = r.context), i.loadBack(e, Utils.extend(w, t), !0)
            }, function() {
                i.allowPageChange = !0
            }))
        }
        ...
        return w.preload ? C() : processRouteQueue.call(i, r, i.currentRoute, function() {
            r.route.modules ? p.loadModules(Array.isArray(r.route.modules) ? r.route.modules : [r.route.modules]).then(function() {
                C()
            }).catch(function() {
                x()
            }) : C()
    ...
    function clearPreviousPages() {
        var r = this;
        appRouterCheck(r, "clearPreviousPages");
        var i = r.app,
            o = r.separateNavbar;
        r.$el.children(".page").filter(function(e, t) {
            return !(!r.currentRoute || !r.currentRoute.modal && !r.currentRoute.panel) || t !== r.currentPageEl
        }).each(function(e, t) {
            var a = $(t),
                n = $(i.navbar.getElByPage(a));
    ...
    function clearPreviousHistory() {
        var e = this;
        appRouterCheck(e, "clearPreviousHistory");
        ...
        return i && (e.__proto__ = i), ((e.prototype = Object.create(i && i.prototype)).constructor = e).prototype.animatableNavElements = function(a, n) {
            ...
            if (void 0 === i && (i = {}), t) {
                ...
                if (l.length) {
                    ...
                    var u = "page" + (e[0].toUpperCase() + e.slice(1, e.length)),
                        h = "page:" + e.toLowerCase(),
                        f = {};
                    ...
                    void 0 === v && (v = {});
                    var g = m.once;
                    if (void 0 === g && (g = {}), i.on && Utils.extend(v, i.on), i.once && Utils.extend(g, i.once), "mounted" === e && w(), "init" === e) {
                    ...
                    c && "beforeOut" === e && "current" === n && "next" === r && delete s.scrollHistory[f.route.url], l.trigger(h, f), s.emit(u, f), "beforeRemove" !== e && "beforeUnmount" !== e || (l[0].f7RouteEventsAttached && (l[0].f7RouteEventsOn && Object.keys(l[0].f7RouteEventsOn).forEach(function(e) {
            ...
            function w() {
                l[0].f7RouteEventsAttached || (l[0].f7RouteEventsAttached = !0, v && 0 < Object.keys(v).length && (l[0].f7RouteEventsOn = v, Object.keys(v).forEach(function(e) {
            ...
            var t = this;
            appRouterCheck(t, "updateCurrentUrl"), t.history.length ? t.history[t.history.length - 1] = e : t.history.push(e);
        ...
        if (p.on("click", function(e) {
                ...
                if (a && (t.is(p.params.clicks.externalLinks) || r && 0 <= r.indexOf("javascript:"))) {
                    ...
                    if (a && (e.preventDefault(), s = t.dataset()), r && 0 < r.length && "#" !== r && !i || t.hasClass("back")) {
                        ...
                        t[0].f7RouteProps && (s.props = t[0].f7RouteProps), t.hasClass("back") ? l.router.back(r, s) : l.router.navigate(r, s)
                    }
                }
    ...
    var Modal = function(n) {
        ...
        Dialog$1 = {
            ...
            create: function() {
                ...
                var d = c.params.dialog.destroyPredefinedDialogs,
                    p = c.params.dialog.keyboardActions;
                c.dialog = Utils.extend(ModalMethods({
                    ...
                    prompt: function() {
                        ...
                        var n = t[0],
                            ...
                            o = t[3],
                            s = t[4];
                        return "function" == typeof t[1] && (n = (e = t)[0], i = e[1], o = e[2], s = e[3], r = e[4]), s = void 0 === s ? "" : s, new Dialog(c, {
                            title: void 0 === r ? l() : r,
                            text: n,
                            content: '<div class="dialog-input-field item-input"><div class="item-input-wrap"><input type="text" value="' + s + '" class="dialog-input"></div></div>',
                            buttons: [{
            ...
            init: function() {
                ...
                $(doc).on(n.touchEvents.start, ".list.sortable .sortable-handler", function(e) {
                    ...
                    if (n.panel && (n.panel.allowOpen = !0), n.swipeout && (n.swipeout.allow = !0), h.transform(""), u.removeClass("sorting"), f.removeClass("sortable-sorting"), b ? e = b.index() : y && (e = y.index()), n.params.sortable.moveElements && (b && u.insertAfter(b), y && u.insertBefore(y)), (b || y) && f.hasClass("virtual-list")) {
                        void 0 === (a = u[0].f7VirtualListIndex) && (a = u.attr("data-virtual-list-index")), y ? void 0 === (e = y[0].f7VirtualListIndex) && (e = y.attr("data-virtual-list-index")) : void 0 === (e = b[0].f7VirtualListIndex) && (e = b.attr("data-virtual-list-index")), e = null !== e ? parseInt(e, 10) : void 0;
                ...
                if (a.trigger("accordion:beforeopen", {
                    ...
                    if (o.removeAttr("aria-hidden"), 0 === o.length && (o = a.find(".accordion-item-content")), 0 !== o.length) {
                        ...
                        0 < s.length && t.accordion.close(s), o.transitionEnd(function() {
                            a.hasClass("accordion-item-opened") ? (o.transition(0), o.css("height", "auto"), Utils.nextFrame(function() {
                        ...
                        }), o.css("height", o[0].scrollHeight + "px"), a.trigger("accordion:open"), a.addClass("accordion-item-opened"), t.emit("accordionOpen", a[0])
                    }
                }
            },
            close: function(e) {
        ...
        Tab = {
            show: function() {
                ...
                if (y.removeClass("tab-active"), (!m || m && !m.animating || m && l) && (y.trigger("tab:hide"), p.emit("tabHide", y[0])), d.addClass("tab-active"), (!m || m && !m.animating || m && l) && (d.trigger("tab:show"), p.emit("tabShow", d[0])), !c && ((!(c = $("string" == typeof i ? '.tab-link[href="' + i + '"]' : '.tab-link[href="#' + d.attr("id") + '"]')) || c && 0 === c.length) && $("[data-tab]").each(function(e, t) {
    ...
    var Panel = function(p) {
            ...
            return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.init = function() {
                ...
                if (!l.is(t.root) || i.prevAll(".views, .view").length) {
                    var c = t.root.children(".panel, .views, .view").eq(0),
                        d = t.root.children(".statusbar").eq(0);
                    c.length ? i.insertBefore(c) : d.length ? i.insertAfter(c) : t.root.prepend(i), o && o.length && (!o.parent().is(t.root) && 0 === o.nextAll(".panel").length || o.parent().is(t.root) && 0 === o.nextAll(".panel").length) && o.insertBefore(i), a.once("panelClosed", function() {
    ...
    var Form = {
            ...
            function e(t, a) {
                ...
                function I(e) {
                    if (!g && (o.params.draggableBar || 0 !== $(e.target).closest(".range-knob").length)) {
                        var t;
                        S = !1, O.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, O.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, g = !0, C = void 0, x = r.offset().left;
                ...
                function A(e) {
                    if (g) {
                        var t = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                            a = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
                        if (void 0 === C && (C = !!(C || Math.abs(a - O.y) > Math.abs(t - O.x))), C) g = !1;
                        else {
                            e.preventDefault();
                ...
                function B() {
                    ...
                    o.off("change", D), g = !1, E.removeClass("range-knob-active-state"), S && o.$inputEl && !o.dual && o.$inputEl.trigger("change"), S = !1, void 0 !== o.previousValue && (o.dual && (o.previousValue[0] !== o.value[0] || o.previousValue[1] !== o.value[1]) || !o.dual && o.previousValue !== o.value) && (o.$el.trigger("range:changed", o, o.value), o.emit("local::changed rangeChanged", o, o.value))
                }
                ...
                return o.attachEvents = function() {
                    ...
                    o.$el.on(t.touchEvents.start, I, e), t.on("touchmove", A), t.on("touchend:passive", B), t.on("tabShow", R), t.on("resize", R), (T = o.$el.parents(".sheet-modal, .actions-modal, .popup, .popover, .login-screen, .dialog, .toast")).on("modal:open", R), (M = o.$el.parents(".panel")).on("panel:open", R), (P = o.$el.parents(".page").eq(0)).on("page:reinit", R)
                }, o.detachEvents = function() {
                    var e = !!Support.passiveListener && {
                        passive: !0
                    };
                    o.$el.off(t.touchEvents.start, I, e), t.off("touchmove", A), t.off("touchend:passive", B), t.off("tabShow", R), t.off("resize", R), T && T.off("modal:open", R), M && M.off("panel:open", R), P && P.off("page:reinit", R), P = M = T = null
                }, o.useModules(), o.init(), o
            }
            return L && (e.__proto__ = L), ((e.prototype = Object.create(L && L.prototype)).constructor = e).prototype.calcSize = function() {
                ...
                var e, r = this,
                    ...
                    u = t.rtl ? "right" : "left";
                if (r.dual) {
                    var h = [(p[0] - a) / (n - a), (p[1] - a) / (n - a)];
                    l.css(((e = {})[u] = 100 * h[0] + "%", e.width = 100 * (h[1] - h[0]) + "%", e)), s.forEach(function(e, t) {
                        var a = o * h[t],
                            n = o * h[t] - i / 2;
                        n < 0 && (a = i / 2), o < n + i && (a = o - i / 2), e.css(u, a + "px"), c && d[t].text(r.formatLabel(p[t], d[t][0]))
                    })
                } else {
                    var f = (p - a) / (n - a);
                    l.css("width", 100 * f + "%");
                    var m = o * f,
                        v = o * f - i / 2;
                    v < 0 && (m = i / 2), o < v + i && (m = o - i / 2), s[0].css(u, m + "px"), c && d[0].text(r.formatLabel(p, d[0][0]))
                }
                r.dual && 0 <= p.indexOf(a) || !r.dual && p === a ? r.$el.addClass("range-slider-min") : r.$el.removeClass("range-slider-min"), r.dual && 0 <= p.indexOf(n) || !r.dual && p === n ? r.$el.addClass("range-slider-max") : r.$el.removeClass("range-slider-max")
        ...
        Stepper = function(z) {
            function e(e, t) {
                ...
                return a.attachEvents = function() {
                    d.on("click", D), c.on("click", I), a.params.watchInput && i && i.length && (i.on("input", L), i.on("click", A), i.on("blur", R), i.on("keyup", B)), a.params.autorepeat && (e.on("touchstart:passive", M), e.on("touchmove:active", P), e.on("touchend:passive", O))
                }, a.detachEvents = function() {
                    d.off("click", D), c.off("click", I), a.params.watchInput && i && i.length && (i.off("input", L), i.off("click", A), i.off("blur", R), i.off("keyup", B))
    ...
    var methods = ["getHours", "getMilliseconds", "getMinutes", "getSeconds", "getTime", "getTimezoneOffset", "getUTCDate", "getUTCDay", "getUTCFullYear", "getUTCHours", "getUTCMilliseconds", "getUTCMinutes", "getUTCMonth", "getUTCSeconds", "now", "parse", "setHours", "setMilliseconds", "setMinutes", "setSeconds", "setTime", "setUTCDate", "setUTCFullYear", "setUTCHours", "setUTCMilliseconds", "setUTCMinutes", "setUTCMonth", "setUTCSeconds", "toDateString", "toISOString", "toJSON", "toLocaleDateString", "toLocaleTimeString", "toLocaleString", "toTimeString", "toUTCString", "UTC", "valueOf"],
        ...
        Calendar = function(p) {
            ...
            return p && (e.__proto__ = p), ((e.prototype = Object.create(p && p.prototype)).constructor = e).prototype.normalizeDate = function(e) {
                ...
                var l = !o && s.value;
                e ? o && a.setValue(o, 0) : o ? a.setValue(o, 0) : s.value && a.setValue(a.normalizeValues(s.value), 0), a.updateCurrentMonthYear(), a.monthsTranslate = 0, a.setMonthsTranslate(), l ? a.updateValue() : s.header && o && a.updateValue(!0), !i && r && r.length && "md" === n.theme && r.trigger("focus"), a.initialized = !0, a.$months.each(function(e, t) {
                    a.emit("local::monthAdd calendarMonthAdd", t)
    ...
    var Picker = function(c) {
            ...
            return c && (e.__proto__ = c), ((e.prototype = Object.create(c && c.prototype)).constructor = e).prototype.initInput = function() {
                ...
                }), r ? o && n.setValue(o, 0) : o ? n.setValue(o, 0) : s.value && n.setValue(s.value, 0), !i && a && a.length && "md" === t.theme && a.trigger("focus"), n.initialized = !0, e && e.trigger("picker:open", n), a && a.trigger("picker:open", n), n.emit("local::open pickerOpen", n)
            }, e.prototype.onOpened = function() {
                        ...
                        if (t && a)
                            if (void 0 === m && (m = !!(m || Math.abs(a - E.y) > Math.abs(t - E.x))), m) {
                                if (b = p[0].scrollTop, void 0 === y && 0 !== b && (y = !0), !h) {
                                    var i;
                                    if (p.removeClass("ptr-transitioning"), b > p[0].offsetHeight) return void(u = !1);
                                    var o = $(e.target).closest(".ptr-watch-scroll");
                                    if (o.length && o.each(function(e, t) {
                                            t !== s && t.scrollHeight > t.offsetHeight && "auto" === $(t).css("overflow") && 0 < t.scrollTop && (i = !0)
                                        }), i) return void(u = !1);
        ...
        Searchbar = function(k) {
            function e(e, t) {
                ...
                else if (0 < (i = f.parents(".navbar-inner")).length && !(r = $(e.navbar.getPageByEl(i[0]))).length) {
                ...
                return t.foundEl ? o = $(t.foundEl) : "string" == typeof a.params.foundEl && r && (o = r.find(a.params.foundEl)), t.notFoundEl ? s = $(t.notFoundEl) : "string" == typeof a.params.notFoundEl && r && (s = r.find(a.params.notFoundEl)), t.hideOnEnableEl ? l = $(t.hideOnEnableEl) : "string" == typeof a.params.hideOnEnableEl && r && (l = r.find(a.params.hideOnEnableEl)), t.hideOnSearchEl ? p = $(t.hideOnSearchEl) : "string" == typeof a.params.hideOnSearchEl && r && (p = r.find(a.params.hideOnSearchEl)), a.params.backdrop && 0 === (c = a.params.backdropEl ? $(a.params.backdropEl) : r && 0 < r.length ? r.find(".searchbar-backdrop") : f.siblings(".searchbar-backdrop")).length && (c = $('<div class="searchbar-backdrop"></div>'), r && r.length ? 0 < f.parents(r).length && i && 0 === f.parents(i).length ? c.insertBefore(f) : c.insertBefore(r.find(".page-content").eq(0)) : c.insertBefore(f)), a.params.searchContainer && (d = $(a.params.searchContainer)), u = a.params.inputEl ? $(a.params.inputEl) : f.find('input[type="search"]').eq(0), a.params.disableButton && (h = a.params.disableButtonEl ? $(a.params.disableButtonEl) : f.find(".searchbar-disable-button")), Utils.extend(a, {
                    ...
                    f.on("submit", v), a.params.disableButton && a.$disableButtonEl.on("click", C), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.on("click", C), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.on("page:beforeout", x), a.$pageEl.on("page:beforein", E)), a.$inputEl.on("focus", g), a.$inputEl.on("blur", b), a.$inputEl.on(a.params.inputEvents, y), a.$inputEl.on("input:clear", w)
                }, a.detachEvents = function() {
                    f.off("submit", v), a.params.disableButton && a.$disableButtonEl.off("click", C), a.params.disableOnBackdropClick && a.$backdropEl && a.$backdropEl.off("click", C), a.expandable && "ios" === e.theme && a.view && i && a.$pageEl && (a.$pageEl.off("page:beforeout", x), a.$pageEl.off("page:beforein", E)), a.$inputEl.off("focus", g), a.$inputEl.off("blur", b), a.$inputEl.off(a.params.inputEvents, y), a.$inputEl.off("input:clear", w)
                }, a.useModules(), a.init(), a
            }
    ...
    function updateSlides() {
        ...
        if (void 0 !== n) {
            ...
            for (var $, E = t.slidesPerColumn, k = C / E, S = Math.floor(p / t.slidesPerColumn), T = 0; T < p; T += 1) {
                x = 0;
                var M = l.eq(T);
                ...
                if ("none" !== M.css("display")) {
                    if ("auto" === t.slidesPerView) {
                        ...
                        if (A && (M[0].style.transform = "none"), B && (M[0].style.webkitTransform = "none"), t.roundLengths) x = e.isHorizontal() ? M.outerWidth(!0) : M.outerHeight(!0);
                            ...
                            var R = parseFloat(I.getPropertyValue("width")),
                                ...
                                U = parseFloat(I.getPropertyValue("margin-right")),
                                N = I.getPropertyValue("box-sizing");
                            x = N && "border-box" === N ? R + H + U : R + L + z + H + U
                        } else {
                            var F = parseFloat(I.getPropertyValue("height")),
                                ...
                                _ = parseFloat(I.getPropertyValue("margin-bottom")),
                                Y = I.getPropertyValue("box-sizing");
                            x = Y && "border-box" === Y ? F + q + _ : F + V + j + q + _
                        }
            ...
            if (e.virtualSize = Math.max(e.virtualSize, n) + f, r && i && ("slide" === t.effect || "coverflow" === t.effect) && a.css({
                ...
                for (var W = 0; W < c.length; W += 1) {
                    var X = c[W];
                    t.roundLengths && (X = Math.floor(X)), c[W] < e.virtualSize + c[0] && $.push(X)
                }
                c = $
            }
            if (!t.centeredSlides) {
                ...
                for (var G = 0; G < c.length; G += 1) {
                    var J = c[G];
                    t.roundLengths && (J = Math.floor(J)), c[G] <= e.virtualSize - n && $.push(J)
                }
    ...
    var breakpoints = {
        ...
        Browser = {
            ...
            isSafari: (x3a = win.navigator.userAgent.toLowerCase(), 0 <= x3a.indexOf("safari") && x3a.indexOf("chrome") < 0 && x3a.indexOf("android") < 0),
                    ...
                    set: function(e) {
                        if (r !== e) {
                            var t = n.zoom.gesture.$imageEl ? n.zoom.gesture.$imageEl[0] : void 0,
                                a = n.zoom.gesture.$slideEl ? n.zoom.gesture.$slideEl[0] : void 0;
                            n.emit("zoomChange", e, t, a)
                        }
                        r = e
                    }
                })
