...
Framework7.support.webApi = {
    ...
    clipboard: (function() {
        if ('clipboard' in navigator) {
            ...
            if (document.queryCommandSupported('cut') || document.queryCommandSupported('copy') || document.queryCommandSupported('paste')) {
                return true;
            } else {
                return false;
            }
    ...
    fullscreen: (function() {
        if ('requestFullscreen' in document.documentElement || 'webkitRequestFullscreen' in document.documentElement || 'mozRequestFullScreen' in document.documentElement || 'msRequestFullscreen') {
            return true;
        } else {
            return false;
        }
    ...
    pageVisibility: (function() {
        if (typeof document.hidden !== 'undefined' || typeof document.webkitHidden !== 'undefined' || typeof document.mozHidden !== 'undefined' || typeof document.msHidden !== 'undefined') {
            return true;
        } else {
            return false;
        }
    ...
    screenOrientation: (function() {
        if ('orientation' in screen || 'mozOrientation' in screen || 'msOrientation' in screen) {
            return true;
        } else {
            return false;
        }
